...
@interface ScreenShareVideoLayoutTool ()

@property(nonatomic, strong) NSMutableArray<NSLayoutConstraint *> *layoutConstraints;

@end

@implementation ScreenShareVideoLayoutTool
...
- (void)layoutVideos:(NSMutableArray *)videos
    ...
    for (ScreenShareStreamVideo *video in videos) {
...
- (NSArray<UIView *> *)viewListFromVideos:(NSArray *)videos
                               ...
                               ignorVideo:(ScreenShareStreamVideo *)ignorVideo {
    NSMutableArray *views = [[NSMutableArray alloc] init];
    for (ScreenShareStreamVideo *v in videos) {
        if (v == ignorVideo) {
            continue;
        }
